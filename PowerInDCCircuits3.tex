...
def make_problem():
	...
	def rand_R1():
		return random.choice([10, 12, 15, 18, 22,47, 56, 68, 82, 100])
	def rand_V():
		return random.choice([24, 27, 30, 36, 45, 60, 70, 80, 90])
	def rand_R3():
	...
	Vb = rand_battery()
	question_choice = random.choice(["$R_1$", "$R_2$", "$R_3$", "$R_4$"])
		
	problem_template = r'''
	The ideal battery has an emf $V_b=\SI{{{4:.3g}}}{{\volt}}$. The four resistors have resistances of  
    $R_1=\SI{{{0:.4g}}}{{\ohm}}$,
    $R_2=\SI{{{1:.4g}}}{{\ohm}}$,
    $R_3=\SI{{{2:.4g}}}{{\ohm}}$, and
    $R_4=\SI{{{3:.4g}}}{{\ohm}}$.
	...
	\begin{{center}}\begin{{circuitikz}}\draw
		...
		to[short] (.5,4)
		to[resistor=$R_1$] (3,4)
		to[resistor=$R_2$] (5.5,4)
		to[short] (5.5,3)
		to[short] (6,3)
		to[short] (6,0)
		to[resistor=$R_4$] (0,0)
		(5.5,3)	to[short] (5.5,2)
		to[resistor=$R_3$] (.5,2)
		to[short] (.5,3)
    ...
    Given those values, determine the power dissipated by {{{5}}}.
	'''
