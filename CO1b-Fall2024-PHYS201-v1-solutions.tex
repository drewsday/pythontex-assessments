...
% Same running header and footer as the student version, except that the name
% and id# rules give way to ANSWER KEY: nobody writes their name on the key, and
% the two copies must not be mistaken for each other on a desk.
\pagestyle{headandfoot}
\header{\textbf{\class} -- \textbf{\examnum}}{}{\textbf{ANSWER KEY}}
\headrule
